(function() {
  ...
  // Create Root Container (Pins to bottom-right of viewport)
  ...
  button.style.cssText = 'pointer-events:auto;display:flex;align-items:center;gap:12px;padding:12px 20px;background:#4f46e5;color:#ffffff;border:none;border-radius:9999px;cursor:pointer;box-shadow:0 12px 30px -4px rgba(79,70,229,0.5),0 4px 12px rgba(0,0,0,0.3);font-size:13px;font-weight:700;transition:all 0.2s cubic-bezier(0.16,1,0.3,1);outline:none;user-select:none;';
